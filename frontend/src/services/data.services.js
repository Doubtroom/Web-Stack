...
export const questionServices = {
  ...
  getFilteredQuestions: (filters) =>
    apiClient.get(API_ENDPOINTS.QUESTIONS.FILTER, { params: filters }),
  deleteQuestion: (id) => apiClient.delete(API_ENDPOINTS.QUESTIONS.DELETE(id)),
  updateQuestion: (id, formData) =>
    apiClient.patch(API_ENDPOINTS.QUESTIONS.UPDATE(id), formData),
  getUserQuestions: () =>
    apiClient.get(API_ENDPOINTS.QUESTIONS.GET_USER_QUESTIONS),
};
...
export const answerServices = {
  ...
  updateAnswer: (id, data) =>
    apiClient.put(API_ENDPOINTS.ANSWERS.UPDATE(id), data),
...
export const commentServices = {
  createComment: (answerId, data) =>
    apiClient.post(API_ENDPOINTS.COMMENTS.CREATE(answerId), data),
  getCommentsByAnswer: (answerId) =>
    apiClient.get(API_ENDPOINTS.COMMENTS.GET_BY_ANSWER(answerId)),
  deleteComment: (id) => apiClient.delete(API_ENDPOINTS.COMMENTS.DELETE(id)),
  updateComment: (id, data) =>
    apiClient.patch(API_ENDPOINTS.COMMENTS.UPDATE(id), data),
...
export const reportServices = {
  reportQuestion: (questionId, data) =>
    apiClient.post(API_ENDPOINTS.QUESTIONS.REPORT(questionId), data),
  getReportedQuestions: () =>
    apiClient.get(API_ENDPOINTS.QUESTIONS.BASE + "/reported-questions"),
  removeReport: (questionId, reportId) =>
    apiClient.delete(
      API_ENDPOINTS.QUESTIONS.REMOVE_REPORT(questionId, reportId),
    ),
};
...
export const customerCareServices = {
  createRequest: (data) =>
    apiClient.post(API_ENDPOINTS.CUSTOMER_CARE.CREATE, data),
  getAllRequests: () => apiClient.get(API_ENDPOINTS.CUSTOMER_CARE.GET_ALL),
  getUserRequests: () =>
    apiClient.get(API_ENDPOINTS.CUSTOMER_CARE.GET_USER_REQUESTS),
};

// Flashcard Services
export const flashcardServices = {
  upsertStatus: (data) =>
    apiClient.post(API_ENDPOINTS.FLASHCARDS.UPSERT_STATUS, data),
  getAll: () => apiClient.get(API_ENDPOINTS.FLASHCARDS.GET_ALL),
};

export const userServices = {
  updateFeatures: (features) =>
    apiClient.post(API_ENDPOINTS.USER.UPDATE_FEATURES, { features }),
};
