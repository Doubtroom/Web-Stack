        ...
        <div className={`min-h-screen flex items-center justify-center p-4 relative overflow-hidden ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
            ...
            >
                <div className="text-center mb-8">
                    <h1 className={`text-3xl font-bold mb-2 drop-shadow-sm ${isDarkMode ? 'text-white' : 'text-blue-900'}`}>Complete Your Profile</h1>
                    <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>Please provide your academic information</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="">{isFormDataLoading ? 'Loading colleges...' : 'Select your college'}</option>
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="">{isFormDataLoading ? 'Loading branches...' : 'Select your branch'}</option>
                            {branches.map(branch => (
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="">{isFormDataLoading ? 'Loading...' : 'Select type of study'}</option>
                            {studyTypes.map(type => (
