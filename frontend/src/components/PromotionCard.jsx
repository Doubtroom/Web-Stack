...
const PromotionCard = ({
  ...
  return (
    ...
    >
      <div className="dark:hidden flex items-center justify-between p-6">
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-gray-900 drop-shadow-sm">{title}</h3>
            <p className="text-sm mt-1 text-gray-600 opacity-90">{subtitle}</p>
            <Link to={knowMoreLink}>
              <button
                className="mt-2 px-3 py-1 rounded-md text-xs font-medium bg-blue-100 text-blue-800 hover:bg-blue-200 dark:bg-blue-900/40 dark:text-blue-200 dark:hover:bg-blue-900/60 transition"
              >
                Know More
              </button>
            </Link>
      ...
      {/* Dark mode version */}
      <div className="hidden dark:flex items-center justify-between p-6" style={{
        background: 'linear-gradient(135deg, rgba(30,41,59,0.92) 60%, rgba(37,99,235,0.22) 100%)',
      }}>
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="flex-1">
            ...
            <Link to={knowMoreLink}>
              <button
                className="mt-2 px-3 py-1 rounded-md text-xs font-medium bg-blue-900/40 text-blue-200 hover:bg-blue-900/60 transition"
              >
                Know More
              </button>
            </Link>
