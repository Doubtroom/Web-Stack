    ...
    <Link to={link} target="_blank" className="group cursor-pointer">
      <div className="flex items-center space-x-3 sm:space-x-4 transition-all duration-300 hover:scale-105">
        ...
        <div className="text-white">
          <p className="text-xs sm:text-sm opacity-70 group-hover:opacity-100 transition-opacity duration-300">
            {platform}
          </p>
          <p className="font-medium text-xs sm:text-base group-hover:text-teal-400 transition-colors duration-300">
            {username}
          </p>
        </div>
      </div>
